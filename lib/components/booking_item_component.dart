...
class BookingItemComponentState extends State<BookingItemComponent> {
  ...
  Widget build(BuildContext context) {
    log("widget.bookingData.bookingPackage!.imageAttachments.validate()::::::::::;;");
    print(widget.bookingData.isPackageBooking);
    //print(widget.bookingData.bookingPackage!.imageAttachments.validate().first.validate());
    return Container(
